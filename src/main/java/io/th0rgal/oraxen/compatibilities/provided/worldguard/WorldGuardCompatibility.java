...
public class WorldGuardCompatibility extends CompatibilityProvider<WorldGuardPlugin> {
    ...
    public boolean canBreak(Player player, Block block) {
        ...
        return canBypass || query.testBuild(BukkitAdapter.adapt(block.getLocation()), localPlayer, Flags.BLOCK_BREAK) || player.hasPermission("oraxen.worldguard.bypass") || player.hasPermission("oraxen.worldguard.*");
    }
